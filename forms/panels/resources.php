<div class="d4p-group d4p-group-import d4p-group-about">
    <h3><?php _e("Font Icons", "gd-rating-system"); ?></h3>
    <div class="d4p-group-inner">
        <ul style="list-style: outside disc; margin-left: 10px;">
            <li>Font-Awesome Font Icons, by Dave Gandy
                <br/><a href="http://fortawesome.github.io/Font-Awesome/" target="_blank">fortawesome.github.io/Font-Awesome</a></li>
        </ul>
    </div>
</div>
