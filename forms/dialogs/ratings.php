<div style="display: none">
    ...
    <div title="<?php _e("Are you sure?", "gd-rating-system"); ?>" id="gdrts-dialog-ratings-clear">
        <div class="gdrts-inner-content">
            <p><?php _e("All selected rating objects will be reseted, and all log entries associated with them will be removed from database.", "gd-rating-system"); ?></p>
            <p><?php _e("Are you sure you want to proceed? This operation is not reversable!", "gd-rating-system"); ?></p>
        </div>
    </div>
    ...
    <div title="<?php _e("Are you sure?", "gd-rating-system"); ?>" id="gdrts-dialog-ratings-clear-single">
        <div class="gdrts-inner-content">
            <p><?php _e("Rating data for this method will be reseted, and all log entries associated with them will be removed from database.", "gd-rating-system"); ?></p>
            <p><?php _e("Are you sure you want to proceed? This operation is not reversable!", "gd-rating-system"); ?></p>
        </div>
    </div>
</div>