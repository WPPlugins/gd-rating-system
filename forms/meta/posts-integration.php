...
<p>
    ...
    <?php d4p_render_select(array_merge(array('default' => __("Default", "gd-rating-system")), gdrts_admin_shared::data_list_embed_methods()), array('selected' => $_gdrts_method, 'name' => 'gdrts[posts-integration][method]')); ?>
</p>
